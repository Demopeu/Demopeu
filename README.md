...
React 생태계에서 <strong>Next.js</strong>(App Router)와 <strong>Turborepo</strong> 기반의 모노레포 아키텍처 구축에 강점을 가진 프론트엔드 개발자입니다. 프로젝트 규모와 특성에 맞는 <strong>아키텍처 패턴</strong>으로 비즈니스 로직을 체계적으로 분리하고, 유지보수성과 확장성 있는 설계를 지향합니다.<br/><br/>
