...
**다양한 사용자 상황과 예외 흐름**까지 생각하는 개발을 지향합니다.
**사용자 경험과 개발자 유지보수**를 모두 고려한 구조적 설계를 추구합니다.

**Next.js** App Router 기반의 최신 개발 흐름에 익숙하고, 빌드·배포 파이프라인 구성과 개발 생산성 도구 세팅에도 강점을 갖고 있습니다.
또한 머신러닝 모델 파인튜닝과 서빙 경험을 바탕으로, 프론트엔드와 AI 시스템 간 연계를 고려한 개발을 지향합니다.
...
- **ADsP (데이터분석 준전문가)** – 대한상공회의소자격평가사업단, 2025.06.13  
...
- **프론트엔드 1인 구성으로 3개의 앱(App, Admin, Busker)을 모두 설계·개발**하며 구조적 완성도 및 실시간 서비스 구현에서 높은 평가를 받음
...
- **프론트엔드 전담 1인**으로 상세 페이지 전체 UI/UX 구성 및 무한 대댓글 구조 설계·개발
- flat 댓글 데이터를 **parent-child 트리 구조로 변환**하여 UI 성능 최적화
