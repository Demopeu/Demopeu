...
- 채팅과 스트리밍 동시 사용 시, Next.js Parallel Routes로 채팅 목록·채팅방 독립 렌더링, Context로 슬롯 간 상태 동기화
- 페이지 이탈 후 재진입 시, SSE 실시간 수신 + localStorage 채팅 영속성 전략으로 페이지 이탈 후 재진입 시 대화 복원
